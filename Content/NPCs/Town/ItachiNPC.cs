...
namespace NarutoOverhaul.Content.NPCs.Town
{
	...
	// [AutoloadHead] registers ItachiNPC_Head.png (already present on disk) as this NPC's
	// minimap/chat head icon - without it the head texture is never wired up even though the file
	// exists.
	[AutoloadHead]
	public class ItachiNPC : ModNPC
	{
		// Sheet layout from the nano-banana-generated ItachiNPC.png: idle(5)/walking(8). Custom
